...
namespace ThreeKindoms.Core.Units
{
    ...
    public static class CombatUnitDisplay
    {
        ...
        public static string FormatLine(Garrison unit, bool passed = true) =>
            FormatTroopStats(unit, unit, unit, passed, garrisonSite: unit.SiteLabel);
            ...
            string garrisonSite = null)
        {
            ...
            string category = unit is Combat c
                ...
                : unit is Garrison g
                    ? UnitConfigUtil.GetTroopTypeDisplayName(g.TroopType)
                    : "-";
            ...
            string sitePart = string.IsNullOrEmpty(garrisonSite) ? "" : $" 據點{garrisonSite}";
